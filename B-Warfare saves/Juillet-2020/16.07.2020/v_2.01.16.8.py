...
status = cycle(['InterliX', 'v 2.01.16.9', 'RPG', '!help', 'New update'])
...
async def mine(ctx):
    ...
    embed.set_thumbnail(url="https://media.discordapp.net/attachments/721338399562137610/732734690565292113/8096.png")
